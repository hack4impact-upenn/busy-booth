...
-(void)viewWillAppear:(BOOL)animated {
    ...
    self.addressLabel = [[UILabel alloc] initWithFrame:CGRectMake(width/5, height*3/7, 200, 200)];
...
- (void) updateAddressLabel {
    ...
    [geocoder geocodeAddressString:[NSString stringWithFormat:@"%@ %i", address, zip]
                 completionHandler:^(NSArray* placemarks, NSError* error){
                     ...
                     NSDictionary* attrs1 = @{NSFontAttributeName: [UIFont fontWithName:@"Helvetica-Bold" size:16.0f],
                                              NSForegroundColorAttributeName:[UIColor blackColor] };
                     NSDictionary* attrs2 = @{NSFontAttributeName: [UIFont fontWithName:@"Helvetica-Bold" size:20.0f],
                                              NSForegroundColorAttributeName: [UIColor blackColor] };
                     NSDictionary* attrs3 = @{NSFontAttributeName: [UIFont fontWithName:@"Helvetica" size:18.0f],
                     ...
                     NSString *string4 = [NSString stringWithFormat:@"%@, %@ %@", [p.addressDictionary objectForKey:@"City"], p.administrativeArea, p.postalCode];
                     
                     NSMutableAttributedString * line1 = [[NSMutableAttributedString alloc] initWithString: @"Your Polling Place is\n" attributes:attrs1];
                     NSMutableAttributedString * line2 = [[NSMutableAttributedString alloc] initWithString: string2 attributes:attrs2];
                     NSMutableAttributedString * line3 = [[NSMutableAttributedString alloc] initWithString: string3 attributes:attrs3];
                     NSMutableAttributedString * line4 = [[NSMutableAttributedString alloc] initWithString: string4 attributes:attrs3];
